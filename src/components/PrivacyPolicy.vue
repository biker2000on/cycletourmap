  ...
  <v-card>
    ...
    <v-card-text>
      ...
      <p>
        ...
        Tourmap unless otherwise defined in this Privacy
        Policy.
      </p>
      <p>
      ...
      <p>
        ...
        personally identifiable information, including but not limited to email, Strava Authenticaion,. The
      ...
      <p>
        ...
        me at justin@crawfordcreations.org.
      </p>
    </v-card-text>
    <v-card-actions>
      <v-spacer></v-spacer>
      <v-btn color="primary" @click="$emit('close')">Accept</v-btn>
    </v-card-actions>
  </v-card>
</template>
